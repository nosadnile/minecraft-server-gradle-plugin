package net.nosadnile.gradle.minecraft.server.tasks
...
abstract class LaunchMinecraftServerTask : DefaultTask() {
    ...
    object JarUrl {
        ...
        @Serializable
        private data class PurpurBuilds(
            val all: List<String>,
            val latest: String
        )

        @Serializable
        private data class PurpurVersion(
        ...
        /**
         * Using [Purpur](https://purpurmc.org) as [jarUrl].
         *
         * ```
         * jarUrl.set(LaunchMinecraftServerTask.JarUrl.Purpur("1.17.1"))
         * ```
         *
         * @param version [Paper version](https://api.purpurmc.org/v2/purpur)
         * @return URL
         */
        @Suppress("FunctionName")
        fun Purpur(version: String): String {
            val versionsUrl = "https://api.purpurmc.org/v2/purpur"
            val versionsJson = URL("$versionsUrl/$version").readText()
            val build = json.decodeFromString<PurpurVersion>(versionsJson).builds.latest
